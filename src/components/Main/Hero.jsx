...
const Hero = () => {
  ...
  return (
    <div>
      <section className="w-full bg-white text-[#0A2B42] flex flex-col items-center justify-center px-6 sm:px-10 lg:px-16 py-16 mt-10">
        <Nav />
        {/* ---------------- Heading ---------------- */}
        <div className="w-full max-w-6xl mx-auto flex flex-col items-center md:items-start text-center md:text-left mb-10">
          <div className="max-w-3xl">
            ...
            <p className="text-[#99BACE] text-base sm:text-lg leading-relaxed">
              You don’t need to be a lawyer to understand your rights.
              NyaySaathi connects you with verified legal sources, expert
              guidance, and trusted assistance.
            </p>
          </div>
        </div>
